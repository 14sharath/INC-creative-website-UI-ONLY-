...
<div className="project2box2">

</div>

<div className="project2box3">
  <div className="container">

  
<div className="row project2box3firstrow">
  ...
  <div className="col-7 fullcol">
      ...
      <div className="p2image">
         <img src={p1} alt="" height={"300px"} width={"300px"}/>
       </div>
       <div className="dateandtext2 text-center ">
        ...
        <div className="date2 text-center">
          <h3>30DEC</h3>
        </div>
       </div>
       </div>

       <div className="divfooter  pt-5">
      ...
      <div className="seconddiv mt-5">
        <div className="flexing">
      <div className="p2image">
         <img src={p2} alt="" height={"300px"} width={"300px"}/>
       </div>
       <div className="dateandtext2 text-center">
      ...
      <div className="flexing">
      <div className="p2image">
         <img src={p3} alt="" height={"300px"} width={"300px"}/>
       </div>
       <div className="dateandtext2 text-center ">
